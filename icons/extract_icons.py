...
def generate_header_file(icon_data):
    ...
    with open(HEADER_FILE, "w") as f:
        ...
        f.write("}\n")
    print(f"Заголовочный файл {HEADER_FILE} создан.")

def main():
    # Вырезаем иконки из изображения, разделенного на сетку
    icon_paths = extract_icons_from_grid(ICON_SHEET_PATH, GRID_COLS, GRID_ROWS, ICON_SIZE, OUTPUT_DIR)

    # Конвертируем иконки в битовый массив
    icon_data = {}
    ...
    generate_header_file(icon_data)
